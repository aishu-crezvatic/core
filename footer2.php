<footer class="lg:h-screen flex items-end justify-center">
    <div class="w-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black">
        <div class="container">
            <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                    <div class="col-span-full lg:col-span-2">
                        ...
                        <p class="text-white mt-6">BRANCH OFFICE:
                    ...
                    <div class="col-span-1">
                        <h4 class="font-semibold text-gray-100 uppercase">Quick Links</h4>
                        <div class="mt-6 grid space-y-3">
                            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-200" href="<?php echo BASEURL ?>">Home</a></p>
                            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-200" href="<?php echo BASEURL . 'about-us' ?>">About Us</a></p>
                            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-200" href="<?php echo BASEURL . 'contact-us' ?>">Contact Us</a></p>
                            <!-- <p><a class="inline-flex gap-x-2 text-white hover:text-gray-200" href="#">Roadmap</a></p> -->
                        </div>
                    </div>
                    <div class="col-span-1">
                        <h4 class="font-semibold text-gray-100 uppercase">Product</h4>
                        <div class="mt-6 grid space-y-3">
                            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-200" href="<?php echo BASEURL . 'Crushers' ?>">Crusher</a></p>
                            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-200" href="<?php echo BASEURL . 'Feeders_and_Screens' ?>">Feeders & Screens</a></p>
                            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-200" href="<?php echo BASEURL . 'Classifiers' ?>">Classifiers</a></p>
                        </div>
                    </div>
                    <div class="col-span-1">
                        <h4 class="font-semibold text-gray-100 uppercase">Application</h4>
                        <div class="mt-6 grid space-y-3">
                            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-200" href="<?php echo BASEURL . 'Aggregate_CrushingAnd_Screening_Plant' ?>">Aggregate Crushing & Screening Plant</a></p>
                            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-200" href="<?php echo BASEURL . 'Sand_Plant' ?>">Sand Plant</a></p>
                            <p><a class="inline-flex gap-x-2 text-white hover:text-gray-200" href="<?php echo BASEURL . 'Classification' ?>">Classification</a></p>
                        </div>
                    </div>
                </div>
                <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
                    ...
                    <div>
                        <a class="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-white hover:bg-primary transition-all duration-300" href="#">
